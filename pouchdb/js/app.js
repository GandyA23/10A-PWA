...
(function() {
  ...
  // Detecta los cambios en vivo para actualizar la UI
  db.changes({
    since: 'now',
    live: true
  }).on('change', showTodos);
  ...
  function addTodo(text) {
    ...
    /**
     * En caso de que no se pase como parámetro una función callback, 
     * entonces por default va a retornar una Promise
     */
    db.put(todo).then((result) => console.log(result)).catch((error) => console.error(error))
